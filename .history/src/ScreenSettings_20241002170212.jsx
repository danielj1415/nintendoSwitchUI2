                ...
                <div className="rightMenuSettings">
                    ...
                    {selectedOptionIndex === 2 && (
                        <div className="wallpaperPage">
                            ...
                            {settingsWallpaperOptions.slice(0,1).map((wallpaper, index) => (
                                <div
                                    key={index}
                                    className={`themeRow ${selectedWallpaperIndex === index ? "themeRowSelected" : "themeRowNotSelected"} marginLeft144`}
                                >
                                    <div className={`${wallpaper.colorClass} ${selectedWallpaperIndex === index ? "selectedThemeMarginRightSpacing selectedThemeMarginLeftSpacing" : "marginRight16 marginLeft32"}`}></div>
                                    <div className="basicColorContainer">
                                        <p className="subheadingText">{theme.name}</p>
                                    </div>
                                </div>
