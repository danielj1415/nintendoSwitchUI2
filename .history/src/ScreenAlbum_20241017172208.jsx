...
import WallpaperFive from "./assets/images/wallpaperFive.jpg";
...
function ScreenAlbum(){
    ...
    const images = [
        [WallpaperThree, WallpaperSixteen, WallpaperOne, WallpaperTwo, WallpaperFive],
        ...
        [WallpaperFour, WallpaperSeventeen, WallpaperEighteen, WallpaperNineteen, WallpaperTwenty],
    ]
