                ...
                <div className="leftMenuSettings">
                    ...
                    <div
                        ...
                        className={`leftMenuOptions ${
                            // This condition shows the line next to "Themes" if either selectedOptionIndex === 1 or if selectedThemeIndex is being navigated (0 or 1)
                            selectedOptionIndex === index + 1 || (selectedOptionIndex === 1 && selectedThemeIndex !== null) 
                                ? "selectedOption" 
                                : "unselectedOption"
                        }`}
                    >
