...
function ScreenSettings(){
    ...
    const [selectedTheme, setSelectedTheme] = useState(0); // this means the user is selecting White as their theme
    const [selectedThemeOption, setSetSelectedThemeOption] = useState(null); // user is navigating through the theme options array
      useEffect(() => {
