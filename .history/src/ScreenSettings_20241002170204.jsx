                    ...
                    {selectedOptionIndex === 2 && (
                        <div className="wallpaperPage">
                            ...
                            {settingsWallpaperOptions.slice(0,1).map((wallpaper, index) => (
                                ...
                                >
                                    <div className={`${wallpaper.colorClass} ${selectedThemeIndex === index ? "selectedThemeMarginRightSpacing selectedThemeMarginLeftSpacing" : "marginRight16 marginLeft32"}`}></div>
                                    <div className="basicColorContainer">
                                        <p className="subheadingText">{theme.name}</p>
                                    </div>
                                </div>
